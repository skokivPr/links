...
function generateLinks() {
    ...
    categories.forEach((category, categoryIndex) => {
        ...
        category.links.forEach((link, linkIndex) => {
            ...
            // Naprawa otwierania nowej karty: wymuszenie nowej karty tylko dla zewnętrznych linków
            // (Rozpoznajemy linki zaczynające się od "http" jako zewnętrzne)
            if (/^https?:\/\//i.test(link.href)) {
                linkElement.target = "_blank";
                linkElement.rel = "noopener noreferrer";
            } else {
                // Jeśli link jest wewnętrzny (np. #something), nie ustawiaj target="_blank"
